...
生成迁移文件后的目录结构： ![生成迁移文件后](images/p3_13.png)

打开上图中的迁移文件，内容如下： ![迁移文件](images/p3_14.png)
...
![生成迁移文件](images/p3_19.png)

项目目录结构：

![项目目录结构](images/p3_20.png)
...
![执行迁移](images/p3_21.png)

最后我们可以看到数据库中生成的英雄表如下图：

![英雄表](images/p3_22.png)
